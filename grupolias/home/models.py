...
class footer(BaseSetting):
    ...
    Link_a_celular = models.CharField(max_length=10, blank=False, null=False, default="4434714356")
...
class ContactPage(Page):
    ...
    Link_a_Telefono_1 = models.CharField(max_length=10, blank=False, null=False, default="4434714356")
